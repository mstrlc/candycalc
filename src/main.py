...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        mainWindow.resize(420, 530)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(mainWindow.sizePolicy().hasHeightForWidth())
        mainWindow.setSizePolicy(sizePolicy)
        mainWindow.setMinimumSize(QtCore.QSize(420, 530))
...
"}")
        ...
        self.pushButtonMod.setFocusPolicy(QtCore.Qt.NoFocus)
        self.pushButtonMod.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.pushButtonMod.setAcceptDrops(False)
        self.pushButtonMod.setAutoFillBackground(False)
        self.pushButtonMod.setStyleSheet("")
        self.pushButtonMod.setFlat(False)
        self.pushButtonMod.setObjectName("pushButtonMod")
        self.buttonsNum.addButton(self.pushButtonMod)
        self.gridLayout.addWidget(self.pushButtonMod, 2, 4, 1, 1)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.labelSecond.setText(_translate("mainWindow", "845-59"))
        self.labelMain.setText(_translate("mainWindow", "786"))
        ...
        self.pushButtonMod.setText(_translate("mainWindow", "ln"))
